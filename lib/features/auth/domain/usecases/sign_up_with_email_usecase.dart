...
class SignUpWithEmailUsecase with UseCases<Either<Failure,User?>,SignUpWithEmailParams>{
  final _repository = locator<AuthRepository>();
  @override
  Future<Either<Failure, User?>> call(SignUpWithEmailParams params) {
    return _repository.signUpWithEmailAndPassword(params.email, params.password);
