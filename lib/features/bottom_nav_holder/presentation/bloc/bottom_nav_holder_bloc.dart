...
class BottomNavHolderBloc
    extends Bloc<BottomNavHolderEvent, BottomNavHolderState> {
  ...
  FutureOr<void> _onIndexChanged(BottomNavHolderIndexChangedEvent event,
      Emitter<BottomNavHolderState> emit) {
